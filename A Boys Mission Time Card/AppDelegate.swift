...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let rootViewController:HoursViewController = storyboard.instantiateViewControllerWithIdentifier("mainViewController") as! HoursViewController
    ...
    func applicationWillResignActive(application: UIApplication) {
        ...
        employeeSingleton.saveEmployees()
    }
    ...
    func applicationWillEnterForeground(application: UIApplication) {
        ...
        employeeSingleton.loadEmployees()
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "pilatifamily.A_Boys_Mission_Time_Card" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("A_Boys_Mission_Time_Card", withExtension: "momd")!
